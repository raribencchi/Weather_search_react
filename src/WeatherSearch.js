...
function displayForecast(response) {
  ...
  if (index < 6) {
      ...
      <div className="col-2 P-sm-6 border text-center">
      <div className="weather-forecast-date text-center">${formatDay (forecastDay.dt)}</div>
      <img src="http://openweathermap.org/img/wn/${forecastDay.weather[0].icon}@2x.png" alt="" width="42"/>
      <div className= "weather-forecst-temperatures">
      <div className="weather-forecaste-temperature">
      <span className="weather-forecaste-temperature-max">${Math.round(forecastDay.temp.max)}&#176</span>/<span className="weather-forecaste-temperature-min">${Math.round(forecastDay.temp.min)}&#176</span>  
      </div>                   
      </div>
      </div>
      ;}  
